...
@RunWith(Suite.class)
@Suite.SuiteClasses({StringConverterTest.class, NumberConverterTest.class, IteratorConverterTest.class, ObjectArrayConverterTest.class, PrimitiveArrayConverterTest.class})
