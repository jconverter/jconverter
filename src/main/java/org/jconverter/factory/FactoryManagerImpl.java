...
public class FactoryManagerImpl extends FactoryManager {
	 ...
	 */
	public static FactoryManagerImpl createDefault(JGum jgum) {
		FactoryManagerImpl instantiationManager = new FactoryManagerImpl(jgum);
	...
	public FactoryManagerImpl(JGum jgum) {
		this.jgum = jgum;
	}
